...
void f1    ( uint8_t k[16], uint8_t rand[16], uint8_t op_c[16], uint8_t sqn[6], uint8_t amf[2],
             uint8_t mac_a[8] )
{
    uint8_t temp[16];
    uint8_t in1[16];
...
void f1star( uint8_t k[16], uint8_t rand[16], uint8_t op_c[16], uint8_t sqn[6], uint8_t amf[2],
             uint8_t mac_s[8] )
{
    uint8_t temp[16];
    uint8_t in1[16];
